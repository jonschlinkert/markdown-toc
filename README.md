...
- [Options](#options)
  ...
  * [options.keepDiacritics](#optionskeepdiacritics)
- [About](#about)
...
```
Usage: markdown-toc [--json] [--keepDiacritics] [-i] <input>
  ...
  --keepDiacritics: Don't replace diacritics in links
                    (Without this flag, the default is to replace ä to a etc.)
...
### options.keepDiacritics

Type: `Boolean`

Default: `false`

Don't replace diacritics in links (Without this flag, the default is to replace ä to a etc.).
